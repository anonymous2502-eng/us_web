const welcomeTexts = [
  { main: "याद राखणैं घर", sub: "हमर कथा बखत में बचै राखणक ठौर" },
  { main: "우리 추억의 궁전", sub: "우리의 이야기를 시간 속에 간직하는 곳" },
  { main: "A Palace of our Memories", sub: "A place to keep our stories saved in time" }
];
...
const defaultSongTitle = songTitle.innerText;
...
function resumeBackgroundMusic() {
  ...
  resetAllListIcons();
  document.getElementById("playerBar").classList.remove("show-player");
  updatePlayerUI(false);
  songTitle.innerText = defaultSongTitle;
  backgroundAudio.volume = 0.5;
  backgroundAudio.play().catch(error => {
    console.log("Background music resume blocked:", error);
  });
}

playlistAudio.addEventListener("ended", resumeBackgroundMusic);

const songs = {
  perfect: { url: "myAudio/by_my_side.mp3", title: "By My Side - Saint Rene" },
  thousand: { url: "myAudio/a_different_way.mp3", title: "A Different Way - DJ Snake" },
  allofme: { url: "myAudio/cruel_summer.mp3", title: "Cruel Summer - Taylor Swift" }
};
...
const startDate = new Date("2025-11-09T06:00:00").getTime();
